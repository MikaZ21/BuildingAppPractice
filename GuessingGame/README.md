...
### In this guessing game, the player is to correctly guess a randomly selected number between 1 and 100.
### The player can input their guess into the provided input field and submit it useing the button.
...
### The player has a 10 limited time of attempts to guess the correct number.
